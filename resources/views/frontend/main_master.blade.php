          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="form-group" id="size-group">
                ...
                <select class="form-control" id="exampleFormControlSelect1" name="product-size">
              ...
              <div class="form-group" id="color-group">
                ...
                <select class="form-control" id="exampleFormControlSelect2" name="product-color">
