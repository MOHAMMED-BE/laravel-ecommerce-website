            ...
            <div class="header-top-inner">
                <div class="cnt-account">
                    <ul class="list-unstyled">
                        ...
                        <li><a href="#"><i class="icon fa fa-heart"></i>@if(session()->get('language') == 'english') Wishlist @else قائمة الرغبات @endif</a></li>
                        <li><a href="#"><i class="icon fa fa-shopping-cart"></i>@if(session()->get('language') == 'english') My Cart @else عربة التسوق @endif</a></li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-2 animate-dropdown top-cart-row">
                    ...
                    <div class="dropdown dropdown-cart"> <a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown" style="width: 179px">
                                            ...
                                            <div class="yamm-content ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 col-md-2 col-menu">
                                                        ...
                                                        <ul class="links">
                                                            <li><a href="#">@if(session()->get('language') == 'english') {{$subsubcategory->subsubcategory_name_en}} @else {{$subsubcategory->subsubcategory_name_ar}} @endif</a></li>
                                                        </ul>
                                                        @endforeach
                                                    </div>
                                                    @endforeach
