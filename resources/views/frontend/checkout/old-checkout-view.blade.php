                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6 already-registered-login">
                                            <form class="register-form" role="form">
                                                ...
                                                <div class="form-group">
                                                    <label class="info-title" for="shipping_post_code_field"><b>Post Code</b> <span>*</span></label>
                                                    <input type="text" name="shipping_post_code" class="form-control text-input" id="shipping_post_code_field" placeholder="Post Code" required>
                                                </div> <!-- end form-group -->
