...
Route::group(['prefix' => 'user', 'middleware' => ['user', 'auth'], 'namespace' => 'User'], function () {
    ...
    // cancel order list
    Route::get('/cancel/order', [AllUserController::class, 'CancelOrderList'])->name('cancel.orders');
    // tracking order
...
Route::prefix('orders')->group(function () {
    ...
    Route::get('/proccessing/shipped/{order_id}', [OrderController::class, 'ProccessingToshipped'])->name('proccessing.shipped');
    Route::get('/shipped/delivered/{order_id}', [OrderController::class, 'ShippedToDelivered'])->name('shipped.delivered');

    Route::get('/cancel/order/{order_id}', [OrderController::class, 'PendingToCancel'])->name('cancel.order');
